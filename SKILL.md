...
description: >-
  ...
  agentic loops, long-horizon role rotation, background monitoring,
  PR checking and branch auditing, scheduled snoozing, and skill
  retrospectives.
  ...
  /geno-dev-loops-overdrive, /geno-dev-loops-autopilot,
  /geno-dev-loops-boost, /geno-dev-loops-ignition, /geno-dev-prs-check,
...
Dev and infrastructure skills for AI coding agents. Task execution, git history rewriting, worktree management, workspace creation, session forking, end-to-end feature shipping, issue-driven development, agentic loops, long-horizon role rotation, background monitoring, PR checking and branch auditing, scheduled snoozing, and skill retrospectives.
