...
description: >-
  ...
  agentic loops, parallel loops, PR auditing, branch auditing, scheduled
  ...
  /geno-dev-loops-cruise, /geno-dev-loops-nos, /geno-dev-loops-ignition,
...
Dev and infrastructure skills for AI coding agents. Task execution, git history rewriting, worktree management, workspace creation, session forking, end-to-end feature shipping, issue-driven development, agentic loops, parallel loops, PR auditing, branch auditing, scheduled snoozing, and skill retrospectives.
...
| `/geno-dev-loops-nos [task]` | Burst parallel sprint — identifies independent items and spawns subagents in parallel |
